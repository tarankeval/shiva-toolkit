...
: "${SHIVA_HEALTH_SNAPSHOT_FILE:=$SHIVA_STATE_DIR/health.json}"
: "${SHIVA_HEALTH_TIMELINE_FILE:=$SHIVA_STATE_DIR/health.timeline}"
: "${SHIVA_EVENT_FILE:=$SHIVA_STATE_DIR/events.log}"
: "${SHIVA_NOTIFY_QUEUE_FILE:=$SHIVA_STATE_DIR/notify.queue}"
: "${SHIVA_WATCHDOG_STATE_FILE:=$SHIVA_STATE_DIR/watchdog.state}"
: "${SHIVA_WATCHDOG_META_FILE:=$SHIVA_STATE_DIR/watchdog.json}"
: "${SHIVA_DASHBOARD_SNAPSHOT_FILE:=$SHIVA_STATE_DIR/dashboard.json}"
: "${SHIVA_REPAIR_INTERFACE:=}"
: "${SHIVA_OPENVPN_SERVICE:=}"
: "${SHIVA_WATCHDOG_INTERVAL:=60}"
: "${SHIVA_WATCHDOG_FAILURE_THRESHOLD:=1}"
: "${SHIVA_WATCHDOG_AUTO_REPAIR:=false}"
: "${SHIVA_WATCHDOG_REPAIR_TARGETS:=network dns openvpn}"
: "${SHIVA_NOTIFY_ON_WATCHDOG:=true}"
: "${SHIVA_NOTIFY_COOLDOWN_SECONDS:=900}"
: "${SHIVA_NOTIFY_STATE_DIR:=$SHIVA_STATE_DIR/notify}"
